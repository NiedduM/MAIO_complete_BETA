# -*- coding: utf-8 -*-
"""
Created on Wed Dec  3 19:39:26 2025
...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec  3 19:31:05 2025
...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec  3 19:27:50 2025
...
c_RoW = 0.02
alpha_RoW = np.array([0.35, 0.25, 0.4])
...
cap_ut = np.array([[0, 0, 0],[0, 0, 0],[0.9, 0.9, 0]]) #capital target capacity utilization

# delta = np.zeros((n_sector,n_sector))
# gamma = delta
# cap_ut = delta

cap_target_speed = 0.05*np.array([0.05, 0.05, 0])
...
KAU_from_RoW = np.array([[0.0, 0.2, 0.3],[0.1, 0, 0.2],[0, 0.2, 0]])
...
H_from_RoW = np.array([0.1, 0.2, 0.1])
...
Gov_from_RoW = np.array([0.2, 0.1, 0.1])


tax_rates = {}
tax_rates['corporate'] = 0.1
tax_rates['VAT'] = 0.0*np.ones(n_sector)
tax_rates['dividends'] = 0.2
tax_rates['labor'] = {math.inf: 0.2}
...
n_steps = 300
folder_path = 'Experiments/Test/3'
